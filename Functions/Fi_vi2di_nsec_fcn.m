function [Fi_vi2di_nsec] = Fi_vi2di_nsec_fcn(Fc_vi2di,q)
...
Fi_vi2di_nsec = zeros(4,n_sec);

vpos_vi2di = vpos_vi2di_npair_fcn(q(:,1:end-1));

Fi_vi2di_nsec(1,:) = Fc_vi2di.*vpos_vi2di.x./vpos_vi2di.m;
Fi_vi2di_nsec(2,:) = Fc_vi2di.*vpos_vi2di.y./vpos_vi2di.m;
Fi_vi2di_nsec(3,:) = - Fi_vi2di_nsec(1,:);
Fi_vi2di_nsec(4,:) = - Fi_vi2di_nsec(2,:);

% Output Fi_vi2di in the column vector form
Fi_vi2di_nsec = Fi_vi2di_nsec(:);
